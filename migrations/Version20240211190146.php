 ...
 */
final class Version20240211190146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD article_id_id INT NOT NULL, CHANGE article_id article_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `comment` DROP article_id_id, CHANGE article_id article_id INT NOT NULL');
    }
}
